...
public class Game implements GameManager {
	...
	int currentPlayerIndex ; // An integer representing which of the players should play next
	int turn ; // An integer representing the current game turn.
	
	public Game(String playerName) throws IOException{
		// (to be done) bec. did not understand 
