...
//    	individually for each card later)
    	...
    	for(int i = 1 ; i < fullPath.size() - 1; i++){
    		if(fullPath.get(i).getMarble() != null){
    			...
    			if(fullPath.get(i).getCellType().equals(CellType.SAFE))
    				throw new IllegalMovementException("cannot destroy a marble in safe zone in path");
    	...
    	if(target.getMarble() != null ){
	    	...
	    	if(target.getCellType().equals(CellType.SAFE))
				throw new IllegalMovementException("cannot destroy a marble in safe zone at target");
    	}
    }
    ...
    private void validateSwap(Marble marble_1, Marble marble_2) throws IllegalSwapException{
    	...
    	if(player_colour == marble_2.getColour()){
    	...
    	if(player_colour == marble_1.getColour()){
    ...
    private void validateDestroy(int positionInPath) throws IllegalDestroyException{
    	...
    	if( m != null && getBasePosition(m.getColour()) == positionInPath)
    ...
    private void validateFielding(Cell occupiedBaseCell) throws CannotFieldException{
    	...
    	if(occupiedBaseCell.getMarble() != null && occupiedBaseCell.getMarble().getColour() == player_colour)
