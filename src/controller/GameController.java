...
public class GameController {
	...
	int splitting;
	Label descriptions;
	Label descriptiontital;
	

	public GameController(String name, Label descriptions) throws IOException{
	...
	public void SetName(Main app,Label message,TextField NameField) throws URISyntaxException{
		...
		if(!NameField.getText().equals(""))
			try {
				...
				Main.showError("Exception","Exception in setting name: "+ e.getMessage());
			}
		else
		...
		for(Card card: cards) {
        	...
        	currToggle.setOnMouseClicked(event -> {
        		...
        		if(currToggle==hand.getLastSelected()) {
	                ...
	                if(!alert) {try {
						Main.showError("Invalid Code Exception", "Chosen code is not in your codex");
    		...
    		this.descriptiontital.setText("Cards Description");
            this.descriptions.setText("                                      " + card.getName() + "\n" + card.getDescription());
    		});
	...
	//public void selectMarble
		...
		public void selectMarble(ArrayList<ArrayList<Circle>> safeZones ,ArrayList<Circle> trackCircles, Circle circle) throws URISyntaxException{
			Marble m = null;
			int indexTrack = -1;
			int indexSafe = -1;
			...
			if(m!= null){
				...
				//	Main.showError("Exception","Invalid Marble Exception: " + e.getMessage());
				}
			}
	...
	//public void fieldmarble
		...
		public void fieldMarble(ArrayList<ArrayList<Circle>> baseZones, ArrayList<Circle> trackCircles) throws URISyntaxException{
			try {
				game.fieldMarble();
				...
				// TODO Auto-generated catch block
				Main.showError("Exception","Cannot Field Exception: " +  e.getMessage());
			} catch (IllegalDestroyException e) {
				// TODO Auto-generated catch block
				Main.showError("Exception","Illegal Destroy Exception: " +  e.getMessage());
			}
...
//						safeZones.get(i).get(v).setStrokeWidth(5);
		...
		public void playGUI(
		        ...
		        MainPlayer player, CPUPlayer1 cpu1, CPUPlayer2 cpu2, CPUPlayer3 cpu3) throws URISyntaxException {
		    ...
		    if (game.canPlayTurn()) {
		    	...
		    	try {
		    		if(game.getPlayers().get(0).getSelectedCard()==null) {
		    			...
		    			Main.showError("No card selected", "Please select a card");
		    			nullSelected=true;
		    			return;
		    		}
		            ...
		            if (game.checkWin() != null) {
		                Main.showError("YOU WINNN!!!!","YOUR ENTIRE CREW HAS ESCAPED !!");
		                return;
		            }
		            ...
		            Main.showError("Wrong Code", " Error while playing player \n        turn:" + e.getMessage());
		        } finally {
		        	
		        	if(!nullSelected) {
		        		
		        		
		        		if(game.isDestroyedByTrap()==true) {
		        			
		        			 String fileName="prisondoor.wav";
		        			...
		        			Main.showError("Trap Door", "One of your members was trapped");}
		        ...
		        Main.showError("Can't play", "Your turn's been skipped");
		        game.skipPlayerTurn();
		        updateBoardSelection(trackCircles, baseZones);
		    }
		    ...
		    KeyFrame frame = new KeyFrame(Duration.seconds(2), event -> {
		        ...
		        if (i[0] < 3) {
		                ...
		                if (game.canPlayTurn()) {
		                    ...
		                    if (game.checkWin() != null) {
		                    	Main.showError("YOU LOST :(","YOUR MEMBERS COULDN'T ESCAPE IN TIME");
		                    	return;
		                    }
		                	} catch (Exception e) {
				                
//				                try {
//						//			Main.showError("Wrong Code", "Error when playing CPU turn: " + e.getMessage());
...
//				            	if(game.isDestroyedByTrap()==true) {try {
//				//					Main.showError("Trap cell", "CPU " + (i[0] + 1) + "'s marble was destoyed");
//								} catch (URISyntaxException e) {
//									// TODO Auto-generated catch block
//									e.printStackTrace();
//								}}
...
//		                    try {
//				//				Main.showError("Can't play", "CPU " + (i[0] + 1) + " had its turn skipped");
//							} catch (URISyntaxException e) {
//								// TODO Auto-generated catch block
//								e.printStackTrace();
//							}
		...
		public void setSplitting(int s) throws URISyntaxException{

			try {
				game.editSplitDistance(s);
			} catch (SplitOutOfRangeException e) {
				Main.showError("Wrong code","   Invalid Split Code" +  e.getMessage());
			}
		}
		...
		public void getSplittingInput(String title, String message) {
		    ...
		    closeButton.setOnAction(event -> {
		        try {
		            ...
		            try {
						Main.showError("Invalid input", "Please enter a valid number.");
					} catch (URISyntaxException e1) {
						// TODO Auto-generated catch block
						e1.printStackTrace();
					}
		        ...
		        MainPlayer player, CPUPlayer1 cpu1, CPUPlayer2 cpu2, CPUPlayer3 cpu3) throws URISyntaxException
		{
			...
			if(game.getcurrentPlayerIndex() == 0){
				...
				Main.showError("Problem", "Cannot field");
			}
		}
